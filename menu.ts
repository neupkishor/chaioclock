...
export const menuData: MenuItem[] = [
  ...
  { name: "Milk Coffee", description: "Rich and creamy coffee with milk", price: 120, tags: ["milk-base"] },
  ...
  { name: "Black Coffee", description: "Strong, bold black coffee", price: 80, tags: ["water-base", "sugar-free"] },
  { name: "Paneer Momo", description: "Steamed dumplings filled with spiced cottage cheese", price: 150, tags: ["vegetarian"] },
  { name: "Chatpatay", description: "Spicy and tangy mixed snack", price: 100, tags: ["vegetarian"] },
  { name: "Wai Wai Sadheko", description: "Spicy Wai Wai noodles salad", price: 80, tags: ["vegetarian"] },
  { name: "Aalo Paratha", description: "Whole wheat flatbread stuffed with spiced potatoes", price: 80, tags: ["vegetarian"] },
  { name: "Aalo Chop (5 pcs)", description: "Crispy spiced potato patties", price: 100, tags: ["vegetarian"] },
  { name: "Veg Pakoda (8 pcs)", description: "Assorted vegetable fritters", price: 100, tags: ["vegetarian"] },
  { name: "Doughnut", description: "Soft, sweet fried dough", price: 25, tags: ["vegetarian"] },
  { name: "Puff", description: "Flaky pastry with savory filling", price: 25, tags: ["vegetarian"] },
  { name: "Cookies", description: "Freshly baked crispy cookies", price: 25, tags: ["vegetarian"] },
  { name: "Soup*", description: "Warm and comforting soup", price: 100, tags: ["vegetarian"] },
  { name: "Chips", description: "Crunchy salted chips", price: 50, tags: ["vegetarian"] },
  { name: "Chips Combo", description: "Chips with a side of chutney", price: 70, tags: ["vegetarian"] },
  { name: "Wai Wai (Soup/Fry)*", description: "Wai Wai noodles with soup or fry", price: 80, tags: ["vegetarian"] },
  { name: "Chicken Momo", description: "Steamed dumplings filled with spiced chicken", price: 160, tags: ["non-vegetarian"] },
  { name: "Keema Paratha", description: "Whole wheat flatbread stuffed with spiced minced meat", price: 100, tags: ["non-vegetarian"] }
];
